    ...
    <section class="con">
      ...
      <div class="mainCon">
        ...
        <div class="previewWrap">
          <!--放大镜效果-->
          <Zoom :imgUrl="skuImageList[currentImgIndex].imgUrl" v-if="skuImageList[currentImgIndex]"/>
          <!-- 小图列表 -->
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(item,index) in spuSaleAttrList" :key="index">
                ...
                <dd changepirce="0" v-for="(value,id) in item.spuSaleAttrValueList" :class="{active:value.isChecked==1}" :key="value.id" @click="updateColor(item.spuSaleAttrValueList,id)">{{value.saleAttrValueName}}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
